...
% Boxplot Monthly
subplot(1,20,1:16);
boxplot(DataTmp,'PlotStyle','compact')
ylabel(NameLabel,'interpreter','latex','FontSize',30, 'FontWeight','bold');
set(gca,'Xtick',1:12,'Xticklabels',NameMonth, 'TickLabelInterpreter','latex','FontSize',28, 'FontWeight','bold')

% Boxplot Annual
subplot(1,20,18:20);
boxplot(Data, 'PlotStyle','compact')
set(gca, 'Xtick',1,'Xticklabels','\bf YEAR','TickLabelInterpreter','latex','FontSize',28, 'FontWeight','bold')
