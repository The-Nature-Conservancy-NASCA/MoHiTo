...
% Last Modified by GUIDE v2.5 25-May-2019 11:50:36
...
% --- Executes on button press in ExpoResults.
function ExpoResults_Callback(hObject, eventdata, handles)

global PathProject TextResults

IDTxT = fopen(fullfile(PathProject, 'RESULTS','Parameters_Model','Summary_Nash_Parameters.txt'),'w');

% TmpTxT = get(handles.List_Results,'string');

fprintf(IDTxT,'%s',TextResults);
